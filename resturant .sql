...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2023 at 11:26 PM
...
(20, 'sweet', 'taste is good'),
(21, 'food', 'you will eat every thing in resturant we go to the bestyou will eat every thing in our resturant we go to the best');
...
('oop', 'mod@gmail.com', 3, 'sanaa hadah', 20),
('ali ali saleh ali', 'modric@gmail.com', 7, 'sanaa hadah', 24),
('kill', 'n@gmail.com', 3, 'sanaa hadah', 24),
('osama', 'mod@gmail.com', 12, 'Taiz', 21);
...
(22, 'chess with meat', 'good food', 120, 'b.jpg', 2),
(23, 'tomato', 'hot', 10, '4.jfif', 2),
(24, 'star', 'make you strong', 400, '1.jfif', 21),
(25, 'Juice', 'To keep your heart strong', 300, '3.jfif', 2);
...
(25, 'kroos', '2a38a4a9316c49e5a833517c45d31070', '12300', 1, 1, 'kroos@gmail.com'),
(29, 'marcelo', '182be0c5cdcd5072bb1864cdee4d3d6e', '774884800', 0, 2, 'alialisalehalthearh@gmail.com'),
(31, 'tomato', '6512bd43d9caa6e02c990b0a82652dca', '990', 0, 2, 'modric@gmail.com'),
(32, 'toma', 'c20ad4d76fe97759aa27a0c99bff6710', '1234', 1, 1, 'neymar@gmail.com');
...
ALTER TABLE `content` ADD FULLTEXT KEY `email` (`email`);
ALTER TABLE `content` ADD FULLTEXT KEY `email_2` (`email`);
ALTER TABLE `content` ADD FULLTEXT KEY `email_5` (`email`);
